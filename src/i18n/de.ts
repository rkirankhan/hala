...
export const de: HalaCopy = {
  ...
  integrations: {
    ...
    groups: [
      { key: 'calendars', label: 'Kalender', items: ['Google Kalender', 'Outlook', 'Calendly'] },
      { key: 'food', label: 'Restaurants & Lieferdienste', items: ['OpenTable', 'SevenRooms', 'ResDiary'] },
      { key: 'beauty', label: 'Salons & Praxen', items: ['Fresha', 'Treatwell', 'Phorest'] },
